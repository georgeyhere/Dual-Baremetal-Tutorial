...
################################################################
# This is a generated script based on design: dualBareMetal_test
#
...
# source dualBareMetal_test_script.tcl
...
set design_name dualBareMetal_test
...
proc create_root_design { parentCell } {
  ...
  set cpu0_led [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 cpu0_led ]

  set cpu0_sw [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 cpu0_sw ]

  set cpu1_led [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 cpu1_led ]

  set cpu1_sw [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 cpu1_sw ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports cpu0_sw] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports cpu0_led] [get_bd_intf_pins axi_gpio_0/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports cpu1_sw] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports cpu1_led] [get_bd_intf_pins axi_gpio_1/GPIO2]
