...
#
# test_dualBareMetal.tcl: Tcl script for re-creating project 'test_dualBareMetal'
#
# Generated by Vivado on Sun Dec 12 22:29:42 PST 2021
...
#
# 1. This project restoration tcl script (test_dualBareMetal.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/george/Documents/ngcp/repos/NGCP_2021-2022/test_dualBareMetal/test_dualBareMetal.srcs/sources_1/bd/dualBareMetal_test/hdl/dualBareMetal_test_wrapper.v"
#
...
set _xil_proj_name_ "test_dualBareMetal"
...
set script_file "test_dualBareMetal.tcl"
...
set files [list \
 [file normalize "${origin_dir}/test_dualBareMetal.srcs/sources_1/bd/dualBareMetal_test/hdl/dualBareMetal_test_wrapper.v" ]\
]
...
set file "hdl/dualBareMetal_test_wrapper.v"
...
set_property -name "top" -value "dualBareMetal_test_wrapper" -objects $obj
...
# Proc to create BD dualBareMetal_test
proc cr_bd_dualBareMetal_test { parentCell } {
...
# End of cr_bd_dualBareMetal_test()
cr_bd_dualBareMetal_test ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files dualBareMetal_test.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files dualBareMetal_test.bd ] 
set_property IS_ENABLED "1" [get_files dualBareMetal_test.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files dualBareMetal_test.bd ] 
set_property IS_LOCKED "0" [get_files dualBareMetal_test.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files dualBareMetal_test.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files dualBareMetal_test.bd ] 
set_property PFM_NAME "" [get_files dualBareMetal_test.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files dualBareMetal_test.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files dualBareMetal_test.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files dualBareMetal_test.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files dualBareMetal_test.bd ] 
set_property USED_IN_SIMULATION "1" [get_files dualBareMetal_test.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files dualBareMetal_test.bd ] 
